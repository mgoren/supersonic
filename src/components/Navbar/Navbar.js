    ...
    <>
      ...
      <Box sx={{ display: { xs: 'none', md: 'inline' } }}>
        <Link component={RouterLink} to='/'>
          <img src={process.env.PUBLIC_URL + '/supersonic/logo-sidetext.png'} alt="" style={{ margin: '10px 10px 10px 0px' }}/>
        </Link>
      </Box>

      <Box sx={{ display: { xs: 'inline', sm: 'inline', md: 'none' } }}>
        <Link component={RouterLink} to='/'>
          <img src={process.env.PUBLIC_URL + '/supersonic/logo.png'} alt="" style={{ margin: '10px 10px 10px 0px', height: '80px' }}/>
        </Link>
      </Box>
  ...
  const contentRegistrationOnly = (
    <>
      <Box sx={{ display: { xs: 'none', sm: 'inline' } }}>
        <img src={process.env.PUBLIC_URL + 'supersonic/logo.png'} alt="" style={{ margin: '10px 10px 10px 0px' }}/>
      </Box>
