const config = {
  ...
  EMAIL_CONTACT: 'info@supersoniccontra.dance',
  HOUSING_CONTACT: 'housing@supersoniccontra.dance',
  TECHNICAL_CONTACT: 'tech@supersoniccontra.dance',
  COVID_POLICY_URL: 'www.supersoniccontra.dance/about#wellness',
